...
echo $green"[Author    ]: MOBM TEAM"
echo $yellow"[type     ]: Tool Matematika"
echo $purple"[Thanks To All Member]"
echo $cyan"[ MOBM TEAM ]"
echo $cyan"[Special Thanks   ]: •SwityWaber •Mr.3M0N27"
echo "\033[34;1m[^_^]\033[36;1m===============================================\033[34;1m[^_^]"
echo ""
echo $white".:Ini Adalah Tools Matematika Yang Dibuat Oleh Team MOBM:."
echo $purple"...........::::::::::Karya Anak Bangsa::::::::::..........."
echo $cyan".::Bermimpi lah Setinggi Langit Karena Mimpi itu Gratis:.."
echo $green"......::::::Silahkan di pilih 2000 dapet 3 :v :::::::......"
echo $yellow"========================================================"
echo "\033[36;1m"
